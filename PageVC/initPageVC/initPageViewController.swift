...
class initPageViewController: UIPageViewController, UIPageViewControllerDelegate, UIPageViewControllerDataSource {
    ...
    func newVc(viewController: String) -> UIViewController {
        return UIStoryboard(name: "initPageVCScreen", bundle: nil).instantiateViewController(withIdentifier: viewController)
    }
